      ...
      <div className="max-w-5xl mx-auto space-y-12">
            ...
            {primary.length < 5 && (
              <div className="mt-4 p-4 border border-ash-darker bg-void-light">
                <p className="text-sm text-ash-dark">
                  More episodes coming soon! We're currently building a library of {getRegistryInfo().episodeCount} curated episodes from 298 total episodes.
                </p>
              </div>
            )}
          </motion.div>
        ...
        >
          <div className="text-xs text-ash-darker font-mono">
            Based on {Object.keys(answers).length} questions and 298 episodes of Lenny's Podcast
          </div>
