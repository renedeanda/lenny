...
/**
 * Parse all 303 episode transcripts from the episodes directory
...
function generateTypeScriptFile(episodes) {
  ...
  const ts = `// All 303 episode transcripts - COMPREHENSIVELY PARSED
...
// Main execution
try {
  console.log('🚀 Parsing all 303 episode transcripts...\n');
