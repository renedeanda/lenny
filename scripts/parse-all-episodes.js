...
/**
 * Parse all 294 episode transcripts from the episodes directory
...
function generateTypeScriptFile(episodes) {
  ...
  const ts = `// All 294 episode transcripts - COMPREHENSIVELY PARSED
...
// Main execution
try {
  console.log('🚀 Parsing all 294 episode transcripts...\n');
