...
**PM Philosophy Map** is an interactive experience where product managers discover their philosophy through a dark sci-fi quiz built from 298 episodes of Lenny's Podcast. Every insight, quote, and recommendation is grounded in actual transcript data.
...
│   ├── allEpisodes.ts            # Episode metadata (298 episodes)
...
**What it checks:**
- 301 total URLs (3 static + 298 episodes)
